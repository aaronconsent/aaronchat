...
<script src="/brand/nav.js?v=32" defer></script>
<script src="/brand/chat.js?v=32" defer></script>
<script src="/brand/lead.js?v=32" defer></script>"""
...
<link rel="stylesheet" href="/brand/style.css?v=32">
{PIXEL}
</head>
<body>
{HEADER}"""
